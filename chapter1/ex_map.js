...
// map 함수를 이용해 리팩토링
// 2. 30 미만인 그들의 나이만 다시 출력
const users_under_30_ages = map(users_under_30, function(user) { return user.age; });
console.log('users_under_30_ages: ', users_under_30_ages);

// 4. 나이가 30 이상인 사람들의 이름만 모아서 출력
const users_higher_30_name = map(users_higher_30, function(user) { return user.name; });
console.log('users_higher_30_name: ', users_higher_30_name);
